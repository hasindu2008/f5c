...
SLOW5_LIB = src/slow5/build/libslow5.a

$(BINARY): src/config.h $(HTS_LIB) $(HDF5_LIB) $(OBJ) $(SLOW5_LIB)
	$(CXX) $(CFLAGS) $(OBJ) $(LDFLAGS) $(CUDA_LDFLAGS) $(SLOW5_LIB) -o $@
...
src/slow5/build/libslow5.a:
	make -C src/slow5 -j8 build/libslow5.a
...
clean:
	rm -rf $(BINARY) $(BUILD_DIR)/*.o $(SLOW5_LIB)
