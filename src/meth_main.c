...
int meth_main(int argc, char* argv[]) {
    ...
    fprintf(stderr, "\n[%s] bam time %.6fs", __func__, core->db_bam_time);
    fprintf(stderr, "\n[%s] fasta time %.6fs", __func__, core->db_fasta_time);
    fprintf(stderr, "\n[%s] fast5 time %.6fs", __func__, core->db_fast5_time);
    fprintf(stderr, "\n[%s] \tfast5 open time %.6fs", __func__, core->db_fast5_open_time);
    fprintf(stderr, "\n[%s] \tfast5 read time %.6fs", __func__, core->db_fast5_read_time);
